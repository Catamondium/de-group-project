...
class CommandFile:
    ...
    def lock(self, table_to_ingest):
        ...
        self.kv.put_item(TableName='Locks', Item=i, Expected={'Lock':{'Exists':False}})
    ...
    def put_last_updated(self, table_to_ingest, last_updated_timestamp):
        i = {'Table':{'S':table_to_ingest}, 'Timestamp':{'S':last_updated_timestamp}}
